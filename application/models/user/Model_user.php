...
class Model_user extends CI_Model{
    ...
    public function getDataAlumni($nisn){
        $this->db->where('nisn', $nisn);
        $this->db->join('prodi', 'alumni.kode_prodi = prodi.kode');
    ...
    public function jumlahtopik_angkatan(){
        $this->db->join('alumni' , 'topik.nisn = alumni.nisn');
        $this->db->join('kategori_topik', 'topik.id_kategoritopik = kategori_topik.id_kategoritopik');
        return $this->db->get('topik');
    }
    ...
    public function listtopik($rowpage, $rowno){
        ...
        $this->db->order_by('id_topik', "DESC");
        $this->db->join('alumni', 'topik.nisn = alumni.nisn', "left");
        $this->db->join('kategori_topik', 'topik.id_kategoritopik = kategori_topik.id_kategoritopik', "left");
    ...
    public function userberitaadminlandingpage(){
        $this->db->order_by('id_berita', "DESC");
        $this->db->limit(4);
