...
class Model_Dashboard extends CI_Model{
    ...
    public function countAlumniByProdi()
    {
        // Query untuk menghitung jumlah alumni berdasarkan prodi
        $this->db->select('prodi.nama, fakultas , COUNT(alumni.nisn) as jumlah_alumni');
        $this->db->from('prodi');
    ...
    public function countAlumniByFakultasFilter($fakultas)
    {
        // Query untuk menghitung jumlah alumni berdasarkan prodi
        $this->db->select('prodi.nama, fakultas, jenjang , COUNT(alumni.nisn) as jumlah_alumni');
        $this->db->from('prodi');
