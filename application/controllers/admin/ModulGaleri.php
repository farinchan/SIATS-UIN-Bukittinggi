...
class ModulGaleri extends CI_Controller{
    ...
    public function foto(){
        ...
        $data = array(
            'data' => $this->Model_Galeri->listFoto()
        );
    ...
    public function video(){
        ...
        $data = array(
            'data' => $this->Model_Galeri->listVideo()
        );
    ...
    public function tambah(){
        ...
        $data = array(
            'galeri' => $this->Model_Galeri->getDataGaleri()->result()
        );
    ...
    public function edit(){
        ...
        if(empty($id)){
            ...
            $data = array(
                'data' => $this->Model_Galeri->ListData($id)
            );
    ...
    public function hapus_foto($id){
        unlink('assets/galeri/'.$this->Model_Galeri->getFoto($id)->id);
