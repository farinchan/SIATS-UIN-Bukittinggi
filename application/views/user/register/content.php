            ...
            <div class="col-sm-8">
                <section id="team" class="team section-bg" style="background-color: white;">
                    ...
                    <div class="card" style="border: none;">
                        <div class="card-body">
                            <div class="container">
                                <h3 style="margin-top: -70px; margin-bottom: 40px;">Register</h3>
                                <hr><br>
                                ...
                                <form id="register_form" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-sm-10">
                                            <select class="form-select" aria-label="Default select example" required name="kampus_lulus">
                                                <option value="">Pilih Nama Kampus Lulus</option>
                                                <option value="STAIN Sjech M. Djamil Djambek Bukittinggi">STAIN Sjech M. Djamil Djambek Bukittinggi</option>
                                                <option value="IAIN Bukittinggi">IAIN Bukittinggi</option>
                                                <option value="UIN Sjech M. Djamil Djambek Bukittinggi">UIN Sjech M. Djamil Djambek Bukittinggi</option>
                                            </select>
                                        </div>
                                    </div>
