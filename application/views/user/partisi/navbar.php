...
<section id="topbar" class="d-flex align-items-center">
    <div class="container d-flex justify-content-center justify-content-md-between">
        <div class="contact-info d-flex align-items-center">
            <b>Aktifitas</b>&nbsp;<marquee> <?php foreach ($listberita as $x) {
                                                echo "<a href='" . base_url('main/bacaberita/' . $x->id_berita) . "' style='color:white;'>" . $x->judul_berita . "</a>" . " , ";
                                            } ?></marquee>
        </div>
...
<header id="header" class="d-flex align-items-center">
    <div class="container d-flex align-items-center justify-content-between">
        <h1 class="logo"><a href="<?php echo base_url('main') ?>"><img src="<?php echo base_url('assets/img/' . $x->logo); ?>" alt="" class="img-fluid"></a></h1>
    <?php endforeach; ?>
    ...
    <nav id="navbar" class="navbar">
        <ul>
            ...
            <?php if ($this->session->flashdata('location') == "GisAlumni") { ?>
                <li><a class="nav-link scrollto active" href="<?php echo base_url('main/gisalumni'); ?>">Persebaran Alumni</a></li>
            <?php } else { ?>
                <li><a class="nav-link scrollto" href="<?php echo base_url('main/gisalumni'); ?>">Persebaran Alumni</a></li>
            <?php } ?>
            

            <li class="nav-link dropdown <?= $this->session->flashdata('location') == "statistik" ? "active" : "" ?>  "><a href="#"><span>Statistik</span> <i class="bi bi-chevron-down"></i></a>
                <ul>
                    <li><a href="<?php echo base_url('main/statistik'); ?>">Statistik Alumni</a></li>
                    <li><a href="<?php echo base_url('main/statitikpengguna'); ?>">Statistik Pengguna</a></li>
                </ul>
            </li>

            <li class="nav-link dropdown"><a href="#"><span>Forum</span> <i class="bi bi-chevron-down"></i></a>
                <ul>
            ...
            <?php if ($this->session->flashdata('location') == "pengguna") { ?>
                <li><a class="nav-link scrollto active" href="<?php echo base_url('main/pengguna'); ?>">Pengguna</a></li>
            <?php } else { ?>
                <li><a class="nav-link scrollto" href="<?php echo base_url('main/pengguna'); ?>">Pengguna</a></li>
            <?php } ?>
