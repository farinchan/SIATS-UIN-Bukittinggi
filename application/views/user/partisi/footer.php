...
<div class="footer-top">
    ...
    <div class="row">
        ...
        <!--<h3><img src="<?php echo base_url() ?>assets/img/logo.png" alt="" class="img-fluid" width="45px"><a href="index.html"></a></h3>-->
        <h3><img src="<?php echo base_url('assets/img/'.$x->logo); ?>" alt="" class="img-fluid" width="120px"><a href="index.html"></a></h3>
        <p>
            Sistem Informasi Alumni dan Tracer Study  <br>
            Program Studi Pendidikan Teknik Informatika dan Komputer UIN SMDD Bukittinggi<br>
            <br>
