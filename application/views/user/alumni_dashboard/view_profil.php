                                    ...
                                    <table class="table">
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo $profil->jenjang; ?> <?php echo $profil->nama; ?></td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                <th scope="row">Nama Kampus Saat Lulus</th>
                                                <td><?php echo $profil->kampus_lulus; ?></td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                <th scope="row">Lokasi Instansi</th>
                                                <td>
                                                    <div id="map_viewonly" style="height: 300px;"></div>
