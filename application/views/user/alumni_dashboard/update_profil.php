                        ...
                        <div class="card-body">
                            <?php foreach ($data_profil as $profil) : ?>
                                <form id="updateprofil_form" method="post">
                                    ...
                                    <div class="mb-3 row">
                                        <label for="nama_alumni" class="col-sm-2 col-form-label">program Studi</label>
                                        <div class="col-sm-10">
                                            <select class="form-select" aria-label="Default select example" required name="kode_prodi" id="kode_prodi">
                                                <option value="">Pilih Program Studi</option>
                                                <?php foreach ($prodi as $list_prodi) : ?>
                                                    <option value="<?php echo $list_prodi->kode; ?>" <?= ($list_prodi->kode == $profil->kode_prodi) ? " selected" : ""; ?>><?php echo $list_prodi->jenjang; ?> <?php echo $list_prodi->nama; ?></option>
                                                <?php endforeach; ?>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-3 row">
                                        <label for="staticEmail" class="col-sm-2 col-form-label">Nama Kampus Lulus</label>
                                        <div class="col-sm-10">
                                            <select class="form-select" aria-label="Default select example" required name="kampus_lulus" id="kampus_lulus">
                                                <option value="">Pilih Nama Kampus Lulus</option>
                                                <option value="STAIN Sjech M. Djamil Djambek Bukittinggi" <?php if ($profil->kampus_lulus == "STAIN Sjech M. Djamil Djambek Bukittinggi") { ?> selected <?php } ?>>STAIN Sjech M. Djamil Djambek Bukittinggi</option>
                                                <option value="IAIN Bukittinggi" <?php if ($profil->kampus_lulus == "IAIN Bukittinggi") { ?> selected <?php } ?>>IAIN Bukittinggi</option>
                                                <option value="UIN Sjech M. Djamil Djambek Bukittinggi" <?php if ($profil->kampus_lulus == "UIN Sjech M. Djamil Djambek Bukittinggi") { ?> selected <?php } ?>>UIN Sjech M. Djamil Djambek Bukittinggi</option>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-sm-10">
                                            ...
                                            <small style="font-size: 12px;"><i>Nama Instansi Tempat Bekerja</i></small>
                                        </div>
                                    </div>

                                    <div class="mb-3 row">
                                        <label for="nama_alumni" class="col-sm-2 col-form-label">Lokasi Instansi</label>
                                        <div class="col-sm-10">
                                            <div id="map" style="height: 400px;"></div>
                                            <small style="font-size: 12px;"><i>Drag Marker Kelokasi Instansi Anda</i></small>
                                        </div>
                                        <input type="hidden" name="latitude" id="latitude" value="<?= $profil->latitude ?>" readonly><br>
                                        <input type="hidden" name="longitude" id="longitude" value="<?= $profil->longitude ?>" readonly><br>
                                    </div>
                                        ...
                                        <div class="col-sm-10">
                                            <table class="table table-bordered" id="tbl_riwayatpendidikan">
                                                <tbody id="tbl_riwayatpendidikan_body">
                                                    ...
                                                    <?php else : ?>
                                                        <?php $i = 0;
                                                        foreach ($riwayatpendidikan as $x) : ?>
                                                            <?php if ($i == 0) : ?>
                                                                <tr id="">
