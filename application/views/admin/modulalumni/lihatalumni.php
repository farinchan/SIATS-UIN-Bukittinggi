        ...
        <div class="card">
            ...
            <form id="updateprofilalumni_form" method="post">
                ...
                <?php if ($this->session->userdata('role') == 'superadmin'){ ?>
                        ...
                        <div class="col-sm-10">
                            <select class="form-control" aria-label="Default select example" required name="kode_prodi" id="kode_prodi">
                    ...
                    <?php } else { ?>
                        <input type="hidden" name="kode_prodi" value="<?= $_SESSION["kode_prodi"] ?>">
                    <?php } ?>
