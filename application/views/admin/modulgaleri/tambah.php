                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form id="tambah_galeri" method="post">
                                    <div class="mb-3 row">
                                        <label for="nama_alumni" class="col-lg-2 col-form-label">Kegiatan</label>
                                        <div class="col-sm-10">
                                            <select name="id_galeri" class="custom-select">
                                                <option disabled selected>Pilih Kegiatan</option>
                                                <?php foreach ($galeri as $x) { ?>
                                                    <option value="<?= $x->id_galeri ?>"><?= $x->judul_kegiatan ?></option>
                                                <?php } ?>
                                            </select>
